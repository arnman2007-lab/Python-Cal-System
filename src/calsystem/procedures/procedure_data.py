...
class TestPointData:
    ...
    dut_pre_check_parser: Optional[str] = None  # Parser type: csv_field, string
    dut_pre_check_index: Optional[int] = None  # For CSV responses, which field to compare (0-based)
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "dut_pre_check_parser": self.dut_pre_check_parser,
            "dut_pre_check_index": self.dut_pre_check_index,
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "TestPointData":
        ...
        return cls(
            ...
            dut_pre_check_parser=data.get("dut_pre_check_parser"),
            dut_pre_check_index=data.get("dut_pre_check_index"),
